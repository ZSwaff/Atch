...
public class MessageListAdapter extends BaseAdapter {
    ...
    private View createMeetHereOrThereChat(final Message message, ViewGroup parent) {
        ...
        for (Message response : responses) {
            ...
            int responderColor = recipientUsers.getLighterColor(response.getSenderId());
            ...
            if (responderColor != -1)
                responseLabel.setTextColor(responderColor);
            ...
            if (responderColor != -1)
                responseDate.setTextColor(responderColor);
        }
